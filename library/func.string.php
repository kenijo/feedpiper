...
{
    $pos = strpos($in_that, $this_one);
    return $pos !== false ? substr($in_that, $pos + strlen($this_one)) : '';
}
...
{
    $pos = strpos($in_that, $this_one);
    return $pos !== false ? substr($in_that, 0, $pos) : '';
}
...
{
    return afterLast($this_one, beforeLast($that, $in_that));
}
